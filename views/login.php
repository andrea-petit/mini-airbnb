    ...
    <div class="container">
        <div class="title_logo">
            <div class="auth-header">
                ...
                <h2>
                    <span class="brand-highlight">Wind</span>BnB</h2>
            </div>
        </div>
        ...
        <div class="auth-body">
            ...
            <form action="../actions/user_actions.php?action=login" method="POST">
                ...
                <div style="text-align: right; margin-bottom: 20px;">
                    <a href="olvido_password.php" style="font-size: 14px; color: #717171; text-decoration: none;">¿Olvidaste tu contraseña?</a>
                </div>
